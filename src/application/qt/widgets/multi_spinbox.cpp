...
template <>
class MultiSpinBox<2, int>;
template <>
class MultiSpinBox<2, unsigned int>;
template <>
class MultiSpinBox<2, float>;
template <>
class MultiSpinBox<2, double>;
template <>
class MultiSpinBox<3, int>;
template <>
class MultiSpinBox<3, unsigned int>;
template <>
class MultiSpinBox<3, float>;
template <>
class MultiSpinBox<4, int>;
template <>
class MultiSpinBox<4, unsigned int>;
template <>
class MultiSpinBox<4, float>;
template <>
class MultiSpinBox<4, double>;
} // namespace ui
